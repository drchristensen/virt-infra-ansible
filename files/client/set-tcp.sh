...
sysctl -w net.ipv4.tcp_rmem="20480 1040384 ${MAX_WIN}"
sysctl -w net.ipv4.tcp_wmem="20480 1040384 ${MAX_WIN}"
# Set default window size, used when window size scaling is disabled
sysctl -w net.core.rmem_default=$DEF_WIN
sysctl -w net.core.wmem_default=$DEF_WIN
